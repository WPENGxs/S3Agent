...
'''
gkp_prompt_2 = '''
Is this image-text combo meant to be sarcastic based on this knowledge? Please give your chain-of-thought in format "Chain-of-thought: your chain-of-thought". In the end, you must give the answer in the following JSON format: {"Answer": "<<<yes>>>"} or {"Answer": "<<<no>>>"}.
text: <text>
knowledge: <knowledge>
'''
