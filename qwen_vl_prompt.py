cot_prompt = '''
Is this image-text combo meant to be sarcastic? You need to give the chain-of-thought firstly in the format "Chain-of-thought: your chain-of-thought" and then you must give the answer in the format {"Answer": "yes or no"} to ensure that it can be parsed in json format. Let's think step by step!
text: <text>
'''

ape_cot_prompt = '''
Is this image-text combo meant to be sarcastic? You need to give the chain-of-thought firstly in the format "Chain-of-thought: your chain-of-thought" and then you must give the answer in the format {"Answer": "yes or no"} to ensure that it can be parsed in json format.  Let's work this out in a step by step way to be sure we have the right answer.
text: <text>
'''
