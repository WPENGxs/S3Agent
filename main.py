...
def main():
    ...
    if args.method == 'cot':
        (true_labels, predict_labels) = g.test_cot(image_path, json_path)
    elif args.method == 'ape_cot':
        (true_labels, predict_labels) = g.test_ape_cot(image_path, json_path)
    elif args.method == 'ps':
        (true_labels, predict_labels) = g.test_ps(image_path, json_path)
    elif args.method == 'gkp':
        (true_labels, predict_labels) = g.test_gkp(image_path, json_path)
