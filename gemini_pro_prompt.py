cot_prompt = '''
Is this image-text combo meant to be sarcastic? Please give your rationale, and in the end give the answer in the format {"Answer": "yes or no"} to ensure that it can be parsed in json format. Let's think step by step!
text: <text>
'''

ape_cot_prompt = '''
Is this image-text combo meant to be sarcastic? Please give your rationale, and in the end give the answer in the format {"Answer": "yes or no"} to ensure that it can be parsed in json format. Let's work this out in a step by step way to be sure we have the right answer.
text: <text>
'''

ps_prompt = '''
Is this image-text combo meant to be sarcastic? Please give your rationale, and in the end give the answer in the format {"Answer": "yes or no"} to ensure that it can be parsed in json format. Let's first understand the problem and devise a plan to solve the problem. Then, let's carry out the plan to solve the problem step by step.
text: <text>
'''
