...
class llava_v1_5():
  ...
  def test_cot(self, image_path, json_path):
    ...
    with tqdm(total=len(data)) as pbar:
      for d in data:
        ...
        gen_text = self.llava_v1_5_generate_single(image_path_, prompt)
    ...
    output_file = open('./saved_documents/llava_v1_5/output_cot.json', 'w', encoding='utf-8')
  ...
  def test_ape_cot(self, image_path, json_path):
    ...
    output_file = open('./saved_documents/llava_v1_5/output_ape_cot.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
  ...
  def test_ps(self, image_path, json_path):
    ...
    output_file = open('./saved_documents/llava_v1_5/output_ps.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
  ...
  def test_gkp(self, image_path, json_path):
    ...
    with tqdm(total=len(data)) as pbar:
      for d in data:
        ...
        knowledge = self.llava_v1_5_generate_single(image_path_, prompt)
    ...
    output_file = open('./saved_documents/llava_v1_5/output_gkp.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
