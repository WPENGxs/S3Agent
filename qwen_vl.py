...
class qwen_vl():
  ...
  def test_cot(self, image_path, json_path):
    ...
    with tqdm(total=len(data)) as pbar:
      for d in data:
        ...
        gen_text = self.qwen_vl_generate_single(image_path_, prompt)
    ...
    output_file = open('./saved_documents/qwen_vl/output_cot.json', 'w', encoding='utf-8')
  ...
  def test_ape_cot(self, image_path, json_path):
    ...
    output_file = open('./saved_documents/qwen_vl/output_ape_cot.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
  ...
  def test_ps(self, image_path, json_path):
    ...
    output_file = open('./saved_documents/qwen_vl/output_ps.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
  ...
  def test_gkp(self, image_path, json_path):
    ...
    with tqdm(total=len(data)) as pbar:
      for d in data:
        ...
        knowledge = self.qwen_vl_generate_single(image_path_, prompt)
    ...
    output_file = open('./saved_documents/qwen_vl/output_gkp.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
