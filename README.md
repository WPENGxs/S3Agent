...
# method = ['cot', 'ape_cot', 'ps', 'gkp', 'agent']
cot: Zero-shot CoT, ape_cot: Automatic Prompt Engineer, ps: Plan-and-Solve, gkp: Generated Knowledge Prompting, agent: S^3 Agent.
# eval = ['test', 'valid']
```
...
Please create Github issues here or email [Peng Wang](mailto:wpengxss@gmail.com) if you have any questions or suggestions. 