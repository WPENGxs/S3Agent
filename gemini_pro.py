...
class gemini_pro():
  ...
  def test_cot(self, image_path, json_path):
    ...
    with tqdm(total=len(data)) as pbar:
      for d in data:
        ...
        gen_text = self.gemini_generate_single(image, prompt)
    ...
    output_file = open('./saved_documents/gemini_pro/output_cot.json', 'w', encoding='utf-8')
  ...
  def test_ape_cot(self, image_path, json_path):
    ...
    output_file = open('./saved_documents/gemini_pro/output_ape_cot.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
  ...
  def test_ps(self, image_path, json_path):
    ...
    output_file = open('./saved_documents/gemini_pro/output_ps.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
  ...
  def test_gkp(self, image_path, json_path):
    ...
    with tqdm(total=len(data)) as pbar:
      for d in data:
        ...
        knowledge = self.gemini_generate_single(image, prompt)
    ...
    output_file = open('./saved_documents/gemini_pro/output_gkp.json', 'w', encoding='utf-8')
    output_file.write(output_json)
    output_file.close()
